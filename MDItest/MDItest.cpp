...
BEGIN_MESSAGE_MAP(CMDItestApp, CWinAppEx)
...
// CMDItestApp 사용자 지정 로드/저장 메서드

void CMDItestApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMDItestApp::LoadCustomState()
{
}

void CMDItestApp::SaveCustomState()
{
}
